                  ...
                  <div className="col-xxl-6 col-xl-6 col-lg-6">
                     <div className="about__content pl-70 pr-60 pt-25">
                        <div className="section__title-wrapper mb-25">
                           <h2 className="section__title">Achieve your <br /><span className="yellow-bg-big">Goals <img src="assets/img/shape/yellow-bg-2.png" alt="img not found" /></span>  </h2>
                        ...
                        <div className="about__list mb-35">
                           <ul>
                              <li className="d-flex align-items-center"><i><FontAwesomeIcon icon={['fas', 'check']} /></i> Upskill your organization.</li>
                              <li className="d-flex align-items-center"><i><FontAwesomeIcon icon={['fas', 'check']} /></i> Access more then 100K online courses</li>
                              <li className="d-flex align-items-center"><i><FontAwesomeIcon icon={['fas', 'check']} /></i> Learn the latest skills</li>
                           </ul>
                        </div>
