                        ...
                        <div className="row">
                            <div className="col-xxl-8 col-xl-8 col-lg-8">
                                <div className="events__wrapper">
                                    ...
                                    <span><i><FontAwesomeIcon icon={['fas', 'tag']} /></i></span>
                                ...
                                <div className="events__sidebar pl-70">
                                    ...
                                    <div className="events__info">
                                        ...
                                        <div className="events__info-content mb-35">
                                            <ul>
                                                ...
                                                <div className="events__info-icon">
                                                    <i><FontAwesomeIcon icon={['fas', 'calendar-alt']} /></i>
                                                </div>
                                                ...
                                                <li className="d-flex align-items-center">
                                                <div className="events__info-icon">
                                                    <i><FontAwesomeIcon icon={['fas', 'address-card']} /></i>
                                                </div>
                                                <div className="events__info-item">
                                        ...
                                        <div className="events__join-btn">
                                            <Link href="/contact"><a className="e-btn e-btn-7 w-100">Enroll <i><FontAwesomeIcon icon={['fas', 'arrow-right']} /></i></a></Link>
                                        </div>
                                    </div>
                                    </div>
