...
function CourseGridTab () {

    
    const [values,setValues]=useState("lgs");

    const cars = ["MG Hector", "Hyundai Venue", "Toyota Fortuner",
    "Hyundai Creta"];
    
// const carList = values.map((car) =>
//   <li key={car.toString()}>{car}</li>
// );


    // useEffect(() => {
    //     fetch("https://lms.webbie.business/api/get-all-courses")
    ...
    // useEffect(() => {
    //     const url = "https://lms.webbie.business/api/get-all-courses";
                           ...
                           <div className="course__item white-bg mb-30 fix">
                                ...
                                <div className="course__content">
                                    <div className="course__meta d-flex align-items-center justify-content-between">
                                        ...
                                        <span><i><FontAwesomeIcon icon={['fas', 'book']} /></i>43 Lesson</span>
                                        </div>
                                        <div className="course__rating">
                                        <span><i><FontAwesomeIcon icon={['fas', 'star']} /></i>4.5 (44)</span>
                                        </div>
                                    </div>
                        ...
                        <div className="row">
                            ...
                            <div className="course__item white-bg mb-30 fix">
                                ...
                                <div className="course__content">
                                    <div className="course__meta d-flex align-items-center justify-content-between">
                                        <div className="course__lesson">
                                        <span><i><FontAwesomeIcon icon={['fas', 'book']} /></i>72 Lesson</span>
                                        </div>
                                        <div className="course__rating">
                                        <span><i><FontAwesomeIcon icon={['fas', 'star']} /></i>4.5 (44)</span>
                                        </div>
                            ...
                            <div className="course__item white-bg mb-30 fix">
                                ...
                                <div className="course__content">
                                    <div className="course__meta d-flex align-items-center justify-content-between">
                                        ...
                                        <div className="course__rating">
                                        <span><i><FontAwesomeIcon icon={['fas', 'star']} /></i>4.4 (40)</span>
                                        </div>
                                    </div>
                            ...
                            <div className="course__item white-bg mb-30 fix">
                                ...
                                <div className="course__content">
                                    <div className="course__meta d-flex align-items-center justify-content-between">
                                        <div className="course__lesson">
                                        <span><i><FontAwesomeIcon icon={['fas', 'book']} /></i>14 Lesson</span>
                                        </div>
                                        <div className="course__rating">
                                        <span><i><FontAwesomeIcon icon={['fas', 'star']} /></i>3.5 (55)</span>
                                        </div>
                                    </div>
                            ...
                            <div className="course__item white-bg mb-30 fix">
                                ...
                                <div className="course__content">
                                    <div className="course__meta d-flex align-items-center justify-content-between">
                                        <div className="course__lesson">
                                        <span><i><FontAwesomeIcon icon={['fas', 'book']} /></i>22 Lesson</span>
                                        </div>
                                        <div className="course__rating">
                                        <span><i><FontAwesomeIcon icon={['fas', 'star']} /></i>4.5 (42)</span>
                                        </div>
                                    </div>
                            ...
                            <div className="course__item white-bg mb-30 fix">
                                ...
                                <div className="course__content">
                                    <div className="course__meta d-flex align-items-center justify-content-between">
                                        <div className="course__lesson">
                                        <span><i><FontAwesomeIcon icon={['fas', 'book']} /></i>18 Lesson</span>
                                        </div>
                                        <div className="course__rating">
                                        <span><i><FontAwesomeIcon icon={['fas', 'star']} /></i>4.5 (37)</span>
                                        </div>
                                    </div>
                            ...
                            <div className="course__item white-bg mb-30 fix">
                                ...
                                <div className="course__content">
                                    <div className="course__meta d-flex align-items-center justify-content-between">
                                        <div className="course__lesson">
                                        <span><i><FontAwesomeIcon icon={['fas', 'book']} /></i>13 Lesson</span>
                                        </div>
                                        <div className="course__rating">
                                        <span><i><FontAwesomeIcon icon={['fas', 'star']} /></i>4.5 (72)</span>
                                        </div>
                                    </div>
                            ...
                            <div className="course__item white-bg mb-30 fix">
                                ...
                                <div className="course__content">
                                    <div className="course__meta d-flex align-items-center justify-content-between">
                                        <div className="course__lesson">
                                        <span><i><FontAwesomeIcon icon={['fas', 'book']} /></i>25 Lesson</span>
                                        </div>
                                        <div className="course__rating">
                                        <span><i><FontAwesomeIcon icon={['fas', 'star']} /></i>4.5 (35)</span>
                                        </div>
                                    </div>
                                    <h3 className="course__title"><Link href="/course-details"><a>Creative writing through Storytelling</a></Link></h3>
                                    <div className="course__teacher d-flex align-items-center">
                                        ...
                                        <div className="col-xxl-8 col-xl-8 col-lg-8">
                                            ...
                                            <div className="course__content course__content-3">
                                                <div className="course__meta d-flex align-items-center">
                                                    ...
                                                    <div className="course__rating">
                                                        <span><i><FontAwesomeIcon icon={['fas', 'star']} /></i>3.5 (32)</span>
                                                    </div>
                                                </div>
                                                <h3 className="course__title course__title-3">
                                    ...
                                    <div className="row gx-0">
                                        ...
                                        <div className="col-xxl-8 col-xl-8 col-lg-8">
                                            ...
                                            <div className="course__content course__content-3">
                                                <div className="course__meta d-flex align-items-center">
                                                    <div className="course__lesson mr-20">
                                                        <span><i><FontAwesomeIcon icon={['fas', 'book']} /></i>33 Lesson</span>
                                                    </div>
                                                    <div className="course__rating">
                                                        <span><i><FontAwesomeIcon icon={['fas', 'star']} /></i>3.5 (72)</span>
                                                    </div>
                                                </div>
                                                <h3 className="course__title course__title-3">
                                                    <Link href="/course-details"><a>Creative writing through Storytelling</a></Link>
