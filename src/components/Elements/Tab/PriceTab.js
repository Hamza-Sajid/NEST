                                ...
                                <div className="row">
                                    <div className="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                                        ...
                                        <div className="price__features mb-40">
                                            <ul>
                                                <li><i><FontAwesomeIcon icon={['fas', 'check']} /></i>Course Discussions</li>
                                                <li><i><FontAwesomeIcon icon={['fas', 'check']} /></i>Content Library</li>
                                                <li><i><FontAwesomeIcon icon={['fas', 'check']} /></i>1-hour Mentorship</li>
                                            </ul>
                                        </div>
                                    ...
                                    <div className="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                                        ...
                                        <div className="price__features mb-40">
                                            <ul>
                                                ...
                                                <li><i><FontAwesomeIcon icon={['fas', 'check']} /></i>Content Library</li>
                                                <li><i><FontAwesomeIcon icon={['fas', 'check']} /></i>1-hour Mentorship</li>
                                                <li><i><FontAwesomeIcon icon={['fas', 'check']} /></i>Online Course</li>
                                            </ul>
                                        </div>
