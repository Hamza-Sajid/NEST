                                    ...
                                    <table className="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <div className="product-quantity mt-10 mb-10">
                                                    <div className="product-quantity-form">
                                                        <button className="cart-minus" onClick={this.handleDecrease}><i><FontAwesomeIcon icon={['fas', 'minus']} /></i></button>
                                                        <p>{this.state.num}</p>
                                                        <button className="cart-plus" onClick={this.handleIncrease}><i><FontAwesomeIcon icon={['fas', 'plus']} /></i></button>
                                                    </div>
                                                </div>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <div className="product-quantity mt-10 mb-10">
                                                    <div className="product-quantity-form">
                                                        <button className="cart-minus" onClick={this.handleDecreaseA}><i><FontAwesomeIcon icon={['fas', 'minus']} /></i></button>
                                                        <p>{this.state.numA}</p>
                                                        <button className="cart-plus" onClick={this.handleIncreaseA}><i><FontAwesomeIcon icon={['fas', 'plus']} /></i></button>
                                                    </div>
                                                </div>
                                                </td>
